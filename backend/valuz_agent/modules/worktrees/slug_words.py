"""Word lists for friendly worktree auto-names (design D11).

Adapted from Docker's names generator — moby/moby
``pkg/namesgenerator/names-generator.go`` (Apache-2.0; upstream declares the
list frozen). Adjectives with a clearly negative tone are filtered out: these
words surface in the worktrees panel and in branch names
(``valuz/u-<adjective>-<surname>-<hex>``), so ``angry-…`` / ``boring-…`` read
poorly in a product UI. The surnames honor notable scientists and engineers.

Uniqueness is carried by the hex suffix plus the caller's path-existence
check, never by the words — see ``service._generate_slug``.
"""

from __future__ import annotations

SLUG_ADJECTIVES: tuple[str, ...] = (
    "admiring", "adoring", "affectionate", "amazing", "awesome", "beautiful",
    "blissful", "bold", "brave", "busy", "charming", "clever", "compassionate",
    "competent", "confident", "cool", "dazzling", "determined", "distracted", "dreamy",
    ...
    "magical", "modest", "musing", "mystifying", "nice", "nifty", "nostalgic",
    "objective", "optimistic", "peaceful", "pedantic", "pensive", "practical",
    "priceless", "quirky", "quizzical", "recursing", "relaxed", "reverent", "romantic",
    "serene", "sharp", "silly", "sleepy", "stoic", "strange", "sweet", "tender",
    "thirsty", "trusting", "unruffled", "upbeat", "vibrant", "vigilant", "vigorous",
    "wizardly", "wonderful", "xenodochial", "youthful", "zealous", "zen",
)

SLUG_NOUNS: tuple[str, ...] = (
    "agnesi", "albattani", "allen", "almeida", "antonelli", "archimedes",
    "ardinghelli", "aryabhata", "austin", "babbage", "banach", "banzai", "bardeen",
    "bartik", "bassi", "beaver", "bell", "benz", "bhabha", "bhaskara", "black",
    "blackburn", "blackwell", "bohr", "booth", "borg", "bose", "bouman", "boyd",
    "brahmagupta", "brattain", "brown", "buck", "burnell", "cannon", "carson",
    "cartwright", "carver", "cerf", "chandrasekhar", "chaplygin", "chatelet",
    "chatterjee", "chaum", "chebyshev", "clarke", "cohen", "colden", "cori", "cray",
    "curie", "curran", "darwin", "davinci", "dewdney", "dhawan", "diffie", "dijkstra",
    ...
    "heyrovsky", "hodgkin", "hofstadter", "hoover", "debugging", "hopper", "hugle",
    ...
    "montalcini", "moore", "morse", "moser", "murdock", "napier", "nash", "neumann",
    ...
    "swartz", "swirles", "taussig", "tesla", "tharp", "thompson", "torvalds", "tu",
