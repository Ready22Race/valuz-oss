...
async def run_session_to_idle(
    ...
    *,
    ...
    try:
        ...
        loaded_session = await session_reader().get_session(user_id, session_id)
        ...
        try:
            ...
            after_run = await session_reader().get_session(user_id, session_id)
...
class ActorRunner:
    ...
    async def _run_turn_with_sink(
        ...
        try:
            ...
            loaded = await session_reader().get_session(user_id, session_id)
