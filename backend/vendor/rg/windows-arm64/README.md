...
```
bash scripts/download-rg.sh aarch64-pc-windows-msvc
# then copy the result into backend/vendor/rg/windows-arm64/rg.exe
# and regenerate SHA256SUMS:
( cd backend/vendor/rg/windows-arm64 && shasum -a 256 rg.exe > SHA256SUMS )
```
