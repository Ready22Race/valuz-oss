...
export const Page = defineComponent({
  ...
  component: ({ props, renderNode }) => {
    ...
    const hasHeading = Boolean(
      heading.title || heading.subtitle || heading.meta,
    );
...
export const Divider = defineComponent({
  ...
  component: ({ props }) => {
    ...
    return (
      <div
        className="vgb-divider vgb-divider-labelled"
        data-slot="vgb-divider"
        role="separator"
      >
...
export const AspectRatio = defineComponent({
  ...
  description:
    ...
    'children is the single block to hold; ratio is written "16/9" (the default), "4/3", "1/1" or OpenUI-style "3:2". scale is how an img child fills the box: fill stretches to it, fit letterboxes it (object-fit), defaulting to fill like OpenUI. ' +
  ...
  component: ({ props, renderNode }) => {
    ...
    return (
      <div
        ...
        style={
          scrollsVertically
            ? { maxHeight: cssLength(props.maxHeight, "20rem") }
            : undefined
        }
      >
        {renderNode(children)}
...
export const Collapsible = defineComponent({
  ...
  component: ({ props, renderNode }) => {
    ...
    if (!title)
      return <div className="vgb-collapsible-body">{renderNode(children)}</div>;
    return (
