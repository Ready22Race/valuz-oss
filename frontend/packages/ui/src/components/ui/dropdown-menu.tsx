  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          // DESIGN.md §5.7 通用 Popover/Dropdown
          //   bg --surface, 1px solid --border, radius 10px,
          //   shadow 0 12px 32px -8px rgba(0,0,0,.12), 0 2px 6px rgba(0,0,0,.04)
...
function DropdownMenuSeparator({
  ...
  return (
    <DropdownMenuPrimitive.Separator
      ...
      className={cn(
        "mx-1.5 my-1 h-px bg-[color:var(--fg-3)]",
        className,
      )}
      {...props}
    />
